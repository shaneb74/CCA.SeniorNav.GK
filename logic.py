                ...
                if st.session_state.world_step == 1:
                    with container.container():
                        ...
                        if social:
                            ...
                            _nav_row("Next →", not social, lambda: st.session_state.update(world_step=2) or st.rerun(), 
                                     "← Back", False, lambda: st.session_state.update(planner_step=6) or st.rerun(), "world_1")
                    ...
                    with container.container():
                        ...
                        if geography:
                            ...
                            _nav_row("Next →", not geography, lambda: st.session_state.update(world_step=3) or st.rerun(), 
                                     "← Back", False, lambda: st.session_state.update(world_step=1) or st.rerun(), "world_2")
                ...
                st.write("Thanks for letting me know.")
                    ...
                    with container.container():
                        ...
                        _nav_row("Next", not conditions, lambda: st.session_state.update(planner_step=8) or st.rerun(), 
                                 "← Back", False, lambda: st.session_state.update(world_step=4) or st.rerun(), "world_5")
                    st.markdown("</div>", unsafe_allow_html=True)
