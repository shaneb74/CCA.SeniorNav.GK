...
# Visual shell only: no business logic here
...
small, .stCaption { font-size: var(--muted) !important; color: #666; }
...
# Session state bootstraps (logic.py also guards, but double-safety is cheap)
